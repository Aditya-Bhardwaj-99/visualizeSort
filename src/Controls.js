...
import { Select, TextField, Button, MenuItem, withStyles } from '@material-ui/core';
            ...
            <div className='controls'>
                <ThemeProvider theme={theme}>
                    ...
                    <form className='form' name='form' id='form'>
                            <TextField InputProps={{ className: classes.input }} classes={{ root: classes.root }} placeholder='ex: 1,2,3,4....' className='array' name='array'></TextField>
                            ...
                            <TextField InputProps={{ className: classes.input }} classes={{ root: classes.root }} placeholder='Time to wait before new selections' className='array' name='waittime'></TextField><br/>
